...
- **H46 病根纠正**：旧稿"H46 resid 0.95→0.34"与实测不符——当前
  HEAD 的 H46 是 **max|S|=13.298 / frozen 7 / 364 步**，且 pH 连续化
  前后**逐位相同**（其终值 He=0）。H46 是"Hess 派生行秩亏 → 7 条冻结
  平衡挂 13.3 log 单位未满足驱动"，**只能由联立秩归约解决，与 pH 无关**。
